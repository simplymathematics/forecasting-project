...
For preprocessing of data, we remove near zero predictors, fill in missing values with KNN method, and transform predictors using the Yeo-Johnson transformation method. We also center and scale the data.
...
#model6 <- step(model5, direction = "backward", trace = FALSE)
...
<TODO: Explain the results. Identify predictors. RMSE values are small, so predictions seem useful and accurate?? Is there a clear differentiation between models or roughly equivalent? ... >
